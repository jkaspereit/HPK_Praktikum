...
public class MatrixServiceTest {
    ...
    public final void testMathSeriellDim1() throws Exception {
        ...
        double[][] m2 = {{1},{2},{7}};
        double[][] result = {{-14}};
        assertArrayEquals(result, service.mathSeriell(m1, m2),eps);
    }
    @Test
    ...
    public final void testMathSeriellColumnsNotEqualRows() throws Exception {
        double[][] m1 = {{1},{1},{1}};
    ...
    @Test
    public final void testMathSeriellAddAZero() throws Exception {
        double[][] m1 = {{5,5},{5,5}};
        double[][] m2 = {{5,5},{5,5,5}};
